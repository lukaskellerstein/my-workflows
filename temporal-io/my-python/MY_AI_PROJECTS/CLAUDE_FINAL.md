# OpenAI Agent SDK + Temporal.io Integration Projects

## Overview

This document describes four progressive projects demonstrating the integration of `OpenAI Agent SDK` within temporal.io workflows. Each project builds upon the previous one, showcasing different aspects of AI integration in deterministic workflow orchestration.
...
OpenAI Agent SDK Examples: `/home/lukas/Projects/Github/lukaskellerstein/ai/13_OpenAI_Agent_SDK`

Temporal + OpenAI Agent SDK Examples: `/home/lukas/Projects/Github/temporalio/samples-python/openai_agents`

**Important:**

- If possible use structured output
