 ...
 * Runs the Temporal worker that processes order workflows
 */
...
async function main() {
  try {
    ...
    console.log('Registered workflows: processOrderWorkflow, processOrderItemWorkflow');
    console.log(
      'Registered activities: validateInventory, calculateSubtotal, processPayment, shipOrder'
    );
